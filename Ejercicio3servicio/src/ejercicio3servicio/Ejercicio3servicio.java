...
public class Ejercicio3servicio {
   ...
   int i = 0;
        double imc = 0, mayorEdad = 0;
        double PromedioPesos, PromedioEdad;
        int[] pesos = new int[4];
        boolean[] edades = new boolean[4];
        Persona persona1, persona2, persona3, persona4 = new Persona();
        PersonaServicio servicio = new PersonaServicio();
        System.out.println("Persona " + (i+1));
        persona1 = (servicio.crearPersona());
        edades[i] = servicio.esMayorDeEdad(persona1);
        pesos[i] = servicio.calcularIMC(persona1);
        i++;
        System.out.println("Persona " + (i+1));
        persona2 = (servicio.crearPersona());
        edades[i] = servicio.esMayorDeEdad(persona2);
        pesos[i] = servicio.calcularIMC(persona2);
        i++;
        System.out.println("Persona " + (i+1));
        persona3 = (servicio.crearPersona());
        edades[i] = servicio.esMayorDeEdad(persona3);
        pesos[i] = servicio.calcularIMC(persona3);
        i++;
        System.out.println("Persona " + (i+1));
        persona4 = (servicio.crearPersona());
        edades[i] = servicio.esMayorDeEdad(persona4);
        pesos[i] = servicio.calcularIMC(persona4);
        ...
        PromedioPesos = imc / 4;
        PromedioEdad = mayorEdad / 4;
        System.out.println("El promedio de las personas en su peso ideal es : " + PromedioPesos);
        System.out.println("El promedio de las personas mayores de edad es : " + PromedioEdad);
    }
    }
